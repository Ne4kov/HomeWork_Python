...
#
# # 25. Сделать if в котором будет условие:
# # если item_2, то вывести в консоль (“Переменная item_2 = ”, item_2),
...
#
# # 26. Сделать if в котором будет условие:
# # если item_3, то вывести в консоль (“Переменная item_3 = ”, item_2),
...
#
# # 27. Сделать if в котором будет условие:
# # если item_5, то вывести в консоль (“Переменная item_5 = ”, item_5),
...
#
# # 28. Сделать if в котором будет условие:
# # если item_4, то вывести в консоль (“Переменная item_4 = ”, item_5),
...
# 30. Сделать if в котором будет условие:
# если currency_convertor, то выполнять следующие шаги задания,
...
#                     31.4 Сделать if в котором будет условие:
#                       если target_currency равен ‘eur’, то в теле этого if в значении переменной currency_result
#                       высчитать сколько долларов получится при target_currency_amount и usd_eur_rate.
...
#                       в значении переменной currency_result высчитать сколько долларов получится
...
def convertor(col):
    var_1 = col / usd_eur_rate

    return var_1

get_cur = convertor(target_currency_amount)
print(get_cur)
...
if currency_convertor:
    ...
    if target_currency == 'eur':
        ...
        print(target_currency_amount, eur_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    elif target_currency == 'uah':
        currency_result = target_currency_amount / usd_uah_rate
        print(target_currency_amount, uah_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    elif target_currency == 'chf':
        currency_result = target_currency_amount / usd_chf_rate
        print(target_currency_amount, chf_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    elif target_currency == 'rub':
        currency_result = target_currency_amount / usd_rub_rate
        print(target_currency_amount, rub_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    elif target_currency == 'byn':
        currency_result = target_currency_amount / usd_byn_rate
        print(target_currency_amount, byn_item_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    elif target_currency == 'usd':
        currency_result = target_currency_amount / usd_usd_rate
        print(target_currency_amount, usd_item, '=', round(currency_result, 2), usd_item) #округление до 2 знаков после запятой.
    else:
